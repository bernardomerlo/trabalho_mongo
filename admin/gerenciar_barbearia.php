...
$id_barbearia = $_SESSION["user"]->barbearia_id;

$barbearia = $mongo->selectOne("barbearias", ['_id' => $id_barbearia]);
$barbeiros = $mongo->select("barbeiros", ['barbearia_id' => $id_barbearia, '_id' => ['$ne' => $_SESSION["user"]->_id]]);

foreach ($barbeiros as &$barbeiro) {
    $barbeiro['total_cortes'] = $mongo->count("cortes", ['id_barbeiro' => $barbeiro->_id]);
    $_SESSION['barbeiros'][] = $barbeiro->_id;
}
                ...
                <tbody>
                    <?php foreach ($barbeiros as $barbeiro): ?>
                        <tr>
                            ...
                            <td>
                                <a href="barbeiro/visualizar_barbeiro.php?id=<?= $barbeiro->_id ?>" class="btn btn-info btn-sm">
