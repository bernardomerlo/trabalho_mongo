...
try {
    ...
    if (!in_array($id_barbeiro, $_SESSION['barbeiros'])) {
        header('Location: gerenciar_barbearia.php');
        exit();
    }

    // ta com erro na hora de buscar o barbeiro, o id é passado certo mas a consulta nunca retorna nada
    $barbeiro = $mongo->selectOne("barbeiros", ["_id" => $id_barbeiro]);
    ...
    $total_cortes = $mongo->count("cortes", ["barbeiros_id" => $id_barbeiro]);
} catch (Exception $e) {
